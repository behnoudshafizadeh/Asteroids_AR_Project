...
public class UFO : MonoBehaviour
{
    ...
    {
        // Generate random X, Y, Z coordinates within the specified range.
        float newX = Random.Range(-_xyOffset, _xyOffset);
        float newY = Random.Range(-_xyOffset, _xyOffset);
        float newZ = _spawnDistanceFromPlayer; // Fixed Z-coordinate based on spawn distance.
